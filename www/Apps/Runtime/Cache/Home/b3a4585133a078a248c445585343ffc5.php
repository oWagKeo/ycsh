...
<div class="divCss" id="listPage">
    ...
    <?php else: ?>
        <div class="top" onclick="window.location.href='/index.php/Home/Index/index'"><?php endif; ?>
    ...
    <div class="list" data-type="<?php echo ($_GET["type"]); ?>">
        <ul class="ul1">
            <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                    <a href="/index.php/Home/Index/info/type/<?php echo ($_GET['type']); ?>/gid/<?php echo ($vo["g_id"]); ?>/mark/<?php echo ($_GET["type"]); ?>" style="display: block">
                    <div class="imgBox">
